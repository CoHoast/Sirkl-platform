...
const publicRoutes = ['/login', '/login/mfa', '/login/recovery', '/api/auth', '/api/health', '/api/db', '/api/migrations', '/api/clients', '/respond', '/api/respond', '/api/bill-negotiator/auto-process'];
